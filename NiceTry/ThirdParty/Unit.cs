...
// ReSharper restore CheckNamespace
    ...
    public struct Unit : IEquatable<Unit> {
        ...
        /// <summary>
        ///     Determines whether the two specified Unit values are equal. Because Unit has a single value, this always returns
        ///     true.
        /// </summary>
        ...
        [SuppressMessage("Microsoft.Usage", "CA1801:ReviewUnusedParameters", MessageId = "first",
            Justification = "Parameter required for operator overloading."),
        ...
        /// <summary>
        ///     Determines whether the two specified Unit values are not equal. Because Unit has a single value, this always
        ///     returns false.
        /// </summary>
        /// <param name="first">The first Unit value to compare.</param>
        /// <param name="second">The second Unit value to compare.</param>
