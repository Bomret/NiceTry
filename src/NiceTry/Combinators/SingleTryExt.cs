...
namespace NiceTry.Combinators {
    public static class SingleTryExt {
        /// <summary>
        ///     Returns the only element of a sequence wrapped in a <see cref="Success{T}" /> or returns a
        ///     <see cref="Failure{T}" /> if there is not exactly one element in the sequence.
        /// </summary>
        ...
        /// <summary>
        ///     Returns the only element of a sequence that satisfies a specified condition, wrapped in a
        ///     <see cref="Success{T}" /> or returns a <see cref="Failure{T}" /> if more than one such element exists.
        /// </summary>
        /// <typeparam name="T"></typeparam>
        /// <param name="enumerable"></param>
