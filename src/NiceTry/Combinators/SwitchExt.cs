...
namespace NiceTry.Combinators {
    ...
    public static class SwitchExt {
        /// <summary>
        ///     Returns the specified <paramref name="try"/> if it represents success.
        ///     Otherwise searches the specified <paramref name="candidates"/> for the first success.
        ///     If no success can be found, a <see cref="Failure{T}"/> is returned. 
        /// </summary>
        ...
        /// </exception>
        /// <returns>The first found success or a <see cref="Failure{T}"/>.</returns>
        ...
        /// <summary>
        ///     Searches the specified <paramref name="candidates"/> for the first success.
        ///     If no success can be found, a <see cref="Failure{T}"/> is returned.
        /// </summary>
        /// <param name="candidates"></param>
        /// <typeparam name="T"></typeparam>
        ...
        /// </exception>
        /// <returns>The first found success or a <see cref="Failure{T}"/>.</returns>
        public static Try<T> SwitchOn<T>(this IEnumerable<Try<T>> candidates) {
            candidates.ThrowIfNull(nameof(candidates));
