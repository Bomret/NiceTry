...
namespace NiceTry.Combinators {
    ...
    public static class FirstTryExt {
        ...
        /// </exception>
        [NotNull]
        public static Try<T> FirstTry<T>([NotNull] this IEnumerable<T> enumerable) {
        ...
        /// </exception>
        [NotNull]
        public static Try<T> FirstTry<T>([NotNull] this IEnumerable<T> enumerable, [NotNull] Func<T, bool> predicate) {
            enumerable.ThrowIfNull(nameof(enumerable));
