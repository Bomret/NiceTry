...
namespace NiceTry.Combinators {
    ...
    public static class SelectManyExt {
        /// <summary>
        ///     Projects the value of the specified <paramref name="try" /> into a new <see cref="Try" />, if it represents
        ///     success.
        /// </summary>
        ...
        /// <returns>The resulting <see cref="Try{T}"/>.</returns>
        /// <exception cref="ArgumentNullException">
        ///     <paramref name="try" /> or <paramref name="select" /> is <see langword="null" />.
        /// </exception>        
        public static Try<B> SelectMany<A, B>(this Try<A> @try, Func<A, Try<B>> @select) {
        ...
        /// </exception>
        public static Try<C> SelectMany<A, B, C>(this Try<A> @try, Func<A, Try<B>> trySelect,
