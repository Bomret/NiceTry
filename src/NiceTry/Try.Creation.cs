...
namespace NiceTry {
    ...
    public static partial class Try {
        ...
        /// <summary> Wraps the specified <paramref name="error" /> in a <see cref="NiceTry.Failure{T}" />. </summary>
        ...
        /// <summary>
        ///     Transforms the specified <paramref name="func" /> into a form which can be applied to
        ...
        /// <summary> Wraps the specified <paramref name="value" /> in a new <see cref="NiceTry.Success{T}" />. </summary>
        /// <typeparam name="T"></typeparam>
        ...
        ///     exception is thrown a <see cref="NiceTry.Failure{T}" /> is returned otherwise <see cref="NiceTry.Success{T}" />.
        /// </summary>
